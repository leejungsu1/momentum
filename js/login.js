...
const togglePW = document.querySelector("#answerPw #togglePW");
...
function cookiesLogin() {
  if (
    localStorage.getItem(USER_NAEM) &&
    localStorage.getItem(USER_EMAIL) &&
    localStorage.getItem(USER_PW)
  ) {
...
function pwToggleBtn(event) {
  if (pw.type === "password") {
    pw.type = "text";
    togglePW.src = "./img/eyes.png";
  } else {
    pw.type = "password";
    togglePW.src = "./img/noneEyes.png";
  }
}
...
togglePW.addEventListener("click", pwToggleBtn);
